# this is a code for solving the system for finding steady state/idnividual with FRT -
...
legend("bottomright", legend=c("26.11\u00B0C","30.11\u00B0C","43\u00B0C"), col=c("#009999","#B266FF","#FF99CC"), lty=c(1), lwd=c(2), cex=1.6, bty="n",text.font = 2)
title("Temporal Analysis of Functional Response across Different Temperatures")

# plot ss with different temperatures 
par(cex.lab=1.5, cex.axis=1.4)
plot(t,log(H1), col="#FF9933", type="l",lty=1, lwd=5, xlab = "Time [week]", ylab = "ln(Biomass [C])", ylim = c(-16, -2), xlim = c(0, 500))
...
legend("bottomright", legend=c("26.11\u00B0C: Host", "26.11\u00B0C: Symbiont", "30.11\u00B0C: Host", "30.11\u00B0C: Symbiont","43\u00B0C: Host", "43\u00B0C: Symbiont"), col=c("#FF9933", "#00CC00","#CC6600","#33FF99","#663300","#006600"), lty=c(1,1,2,2,3,3), lwd=c(2,2,2,2,2,2), cex=0.8, bty="n",text.font = 2)
title("Steady state solutions for different temperatures")

# plot ss for host with different temperatures
par(cex.lab=1.5, cex.axis=1.4)
plot(t,H1, col="#FF9933", type="l",lty=1, lwd=5, xlab = "Time [Weeks]", ylab = "Biomass [C]")
lines(t,H2, col="#CC6600", lty=2,lwd =5)
lines(t,H3, col="#663300", lty=3,lwd =5)
# Add a legend with a larger font size
legend("bottomright", legend=c("26.11\u00B0C: Host", "30.11\u00B0C: Host","43\u00B0C: Host"), col=c("#FF9933","#CC6600","#663300"), lty=c(1,2,3), lwd=c(2,2,2), cex=1.2, bty="n",text.font = 2)
title("Steady state solutions for different temperatures - Host")

# plot ss for symbiont with different temperatures
par(cex.lab=1.5, cex.axis=1.4)
plot(t,S1, col="#00cc00", type="l",lty=1, lwd=5, xlab = "Time [Weeks]", ylab = "Biomass [C]")
lines(t,(S2), col="#33FF99", lty=2,lwd =5)
lines(t,(S3), col="#006600", lty=3,lwd =5)
# Add a legend with a larger font size
legend("bottomright", legend=c("26.11\u00B0C: Symbiont","30.11\u00B0C: Symbiont","43\u00B0C: Symbiont"), col=c("#00CC00","#33FF99","#006600"), lty=c(1,2,3), lwd=c(2,2,2), cex=1.2, bty="n",text.font = 2)
title("Steady state solutions for different temperatures - Symbiont")

# plot with different initial values 
par(cex.lab=1.5, cex.axis=1.4)
plot(t,log(H1), col="#FF9933", type="l",lty=1, lwd=5, xlab = "Time [week]", ylab = "Carbon", ylim = c(-20,0))
lines(t,log(S1), col="#00cc00", lty=1,lwd =5)
lines(t,log(funcrespC1), col="#009999", lty=1,lwd =5)
# Add a legend with a larger font size
legend("bottomright", legend=c("26.11\u00B0C: Host", "26.11\u00B0C: Symbiont","26.11\u00B0C: FRT"), col=c("#FF9933","#00cc00","#009999"), lty=c(1,1,1), lwd=c(2,2,2), cex=1.2, bty="n",text.font = 2)
